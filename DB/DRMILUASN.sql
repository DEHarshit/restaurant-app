...
CREATE TABLE IF NOT EXISTS INGREDIENTS( -- INGREDIENT DICTIONARYh
ID INT NOT NULL AUTO_INCREMENT,
NAME VARCHAR(20) UNIQUE,
TYPE VARCHAR(20),
UOM VARCHAR(10),
...
ALTER TABLE BILLS ADD NAME VARCHAR(20);
...
('Kitchen Manager','123123','123123','Kitchen Manager','chef123@gmail.com','9998808652'),
('Customer','123123','123123','Customer','customer123@gmail.com','9875789068');
INSERT INTO USERS (NAME,PASSWORD,PREVPASS,ROLE,EMAIL,PHONE) VALUES
('Stores Manager','123123','123123','Stores Manager','store123@gmail.com','98757759068'),
('Finance Manager','123123','123123','Finance Manager','finance123@gmail.com','9875787068');
...
('Idli Rice','Groceries','g'),
('Urad Dal','Groceries','g'),
('Thick Poha','Groceries','g'),
('Fenugreek Seeds','Groceries','g'),
('Plain Noodles','Groceries','g');
...
SELECT T.INAME INAME,T.QTY QTY,I.UOM FROM TOTAL_STOCK T LEFT JOIN INGREDIENTS I ON I.NAME=T.INAME;
...
CREATE VIEW SUPPLIES_PAST_7_DAYS AS
WITH RECURSIVE calendar AS (
    SELECT CURDATE() - INTERVAL 6 DAY AS SUPPLIED_DATE
    UNION ALL
    SELECT SUPPLIED_DATE + INTERVAL 1 DAY
    FROM calendar
    WHERE SUPPLIED_DATE + INTERVAL 1 DAY <= CURDATE()
)
SELECT calendar.SUPPLIED_DATE, SUM(S.PRICE) AS total_sum
FROM calendar
LEFT JOIN SUPPLIES S ON calendar.SUPPLIED_DATE = S.SUPPLIED_DATE
GROUP BY calendar.SUPPLIED_DATE
ORDER BY calendar.SUPPLIED_DATE;

SELECT * FROM SUPPLIES_PAST_7_DAYS;
