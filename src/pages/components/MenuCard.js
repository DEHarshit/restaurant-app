    ...
    return(
        <div className="p-1 bg-gradient-to-t bg-gradient-to-r from-[#CEA07E] to-[#BB5656] h-[456px] w-[356px] rounded-lg">
            ...
            <div className="flex flex-col gap-3">
                <div> {/* Title */}
                    <h2 className="font-primary text-xl font-semibold leading-5 tracking-wider antialiased transition-all duration-400 hover:text-[#BB5656]">Dish Name</h2>
                ...
                <div className="flex justify-between items-center">
                    <div className="flex gap-1"> {/* Profile Pic & Name */}
                        ...
                        <h2 className="font-primary text-lg">00.99</h2>
                    </div>
                    <div>
