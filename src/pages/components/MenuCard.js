...
export default function MenuCard({
  ...
  return (
    <div className="p-1 bg-gradient-to-t bg-gradient-to-r from-[#CEA07E] to-[#BB5656] h-[456px] w-[356px] rounded-lg">
      <div
        style={{ height: "448px" }}
        className="flex flex-col p-6 justify-between rounded-lg bg-zinc-900 w-fit hover:scale-[1] scale-[1.03] transition-all duration-300 space-y-2"
      >
        ...
        <div className="flex flex-col gap-3">
          <Link href="/DishDetails">
            <div>
              {" "}
              {/* Title */}
              <h2 className="font-primary text-xl font-semibold leading-5 tracking-wider antialiased transition-all duration-400 hover:text-[#BB5656]">
                {name ? name : "Dish Name"}
              </h2>
          ...
          <div className="flex justify-between items-center">
            ...
            <div>
              <button
                onClick={handleCart}
                className="font-primary font-semibold text-lg rounded-full bg-gradient-to-r hover:bg-gradient-to-b from-[#CEA07E] to-[#BB5656] duration-400 transition-colors p-2"
              >
                Add to Cart
              </button>
            </div>
