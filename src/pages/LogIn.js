...
export default function LogIn() {
    ...
    return (
        <div className="relative h-screen flex justify-center items-center">
            ...
            <div className="relative inset-0 h-screen w-screen flex items-center justify-center font-primary">
                    ...
                    {(log) ? (
                        <div className='flex transition-all'>
                            <div style={{
                                ...
                                <div className="w-full h-full bg-black hover:opacity-0 transition-all opacity-60 flex items-center justify-center text-7xl font-semibold tracking-wider">
                                    LOG IN
                                </div>
                            </div>
                            <div className='flex flex-col px-12 py-12 space-y-[50px] bg-zinc-900 h-[485px] w-[485px] rounded-r-lg'>
                                ...
                                <div className="flex flex-col space-y-2 justify-center items-center">
                                    ...
                                    <button type="button" className="text-zinc-400" onClick={() => (setLog(!log))}>Sign in?</button>
                                </div>
                            </div>
                        </div>
                    ) : (
                        <div className='flex transition-all'>
                            <div className='flex flex-col px-10 py-5 space-y-[8px] h-[485px] w-[485px] rounded-l-lg bg-zinc-900'>
                                ...
                                <div className="flex flex-col translate-y-4 space-y-2 justify-center items-center">
                                    ...
                                    <button type="button" className="text-zinc-400" onClick={() => (setLog(!log))}>Log in?</button>
                                </div>
                            </div>
                            <div style={{
                                backgroundImage: `URL(/home-image.jpg)`,
