  ...
  return (
    <div className="relative h-screen flex justify-center items-center font-primary">
      ...
      <div className="relative w-screen flex justify-center font-primary">
            ...
            <div className="flex transition-all">
              ...
              <div className="flex flex-col px-12 py-12 space-y-[50px] bg-zinc-900 h-[485px] w-[485px] rounded-r-lg">
                <h2
                  ...
                  className="text-3xl cursor-pointer font-bold tracking-wider leading-9 space-x-2"
                >
                  ...
                  {!view ? (
                    <span>
                      ...
                      <input
                        ...
                        className="p-1 border bg-zinc-900 border-2 border-white text-white h-[45px] w-[250px] rounded-lg"
                      />
                    </span>
                  ) : (
                    <span>
                  ...
                  <span>
                    ...
                    <span className="flex">
                      ...
                      <button
                        ...
                        className="w-[30px] h-[30px] -translate-x-10 translate-y-2"
                      >
                        <img
                          src={`${
                            visible ? "/visible_on.png" : "/visible_off.png"
                          }`}
                        />
                      </button>
                    </span>
                ...
                <div className="flex flex-col space-y-2 justify-center items-center">
                  ...
                  <button
                    onClick={handleLogIn}
                    type="button"
                    className=" w-fit h-fit bg-zinc-400 hover:text-white text-lg text-black p-2 px-10 font-semibold transition-all duration-400 hover:text-xl rounded-full hover:bg-gradient-to-r from-[#CEA07E] to-[#BB5656]"
                  >
                    Log In
                  </button>
                  <button
                    type="button"
                    className="text-zinc-400 hover:text-[20px] transition-all"
                    onClick={handleLog}
                  >
                    Sign up?
                  </button>
              ...
              <div className="flex flex-col px-10 py-5 space-y-[8px] h-[485px] w-[485px] rounded-l-lg bg-zinc-900">
                ...
                <div>
                  <span>
                    ...
                    <input
                      ...
                      onChange={(e) => setName(e.target.value)}
                      type="text"
                      className="p-1 border bg-zinc-900 border-2 border-white text-white h-[45px] w-[200px] rounded-lg"
                    />
                  </span>
                  <span>
                    <h2 className="bg-zinc-900 p-1 w-fit h-fit translate-x-4 translate-y-3 rounded-lg font-semibold tracking-wide leading-4">
                ...
                <div className="flex flex-col translate-y-4 space-y-2 justify-center items-center">
                  ...
                  <button
                    ...
                    type="button"
                    className=" w-fit h-fit bg-zinc-400 text-lg text-black hover:text-white p-2 px-10 font-semibold transition-all duration-400 hover:text-xl rounded-full hover:bg-gradient-to-r from-[#CEA07E] to-[#BB5656]"
                  >
                    Sign Up
                  </button>
                  <button
        ...
        <div
          className={`${
            transition ? "h-[490px]" : "opacity-0 h-[1px]"
          } transition-all duration-1000 absolute flex bg-gradient-to-r from-[#CEA07E] to-[#BB5656] w-[970px] rounded-lg `}
        ></div>
      </div>
    </div>
  );
