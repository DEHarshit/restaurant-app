...
export default function Admin() {
  ...
  const menu = [
    { title: 'Dashboard', id: 1, role: ['Admin', 'Kitchen Manager', 'Waiter', 'Finance Manager', 'Stores Manager'] },
    { title: 'Orders', id: 2, role: ['Admin', 'Kitchen Manager', 'Waiter'] },
    { title: 'Bills', id: 9, role: ['Admin', 'Finance Manager'] },
    { title: 'All Dishes', id: 3, role: ['Admin', 'Kitchen Manager', 'Waiter'] },
    { title: 'Pre-Made', id: 7, role: ['Admin', 'Kitchen Manager'] },
    { title: 'Users', id: 4, role: ['Admin',] },
    { title: 'Ingredients', id: 5, role: ['Admin', 'Kitchen Manager'] },
    { title: 'Stock', id: 6, role: ['Admin', 'Kitchen Manager', 'Stores Manager'] },
    { title: 'Supplies', id: 8, role: ['Admin', 'Stores Manager'] },
  ]
